    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    ajaximage.fields.AjaxImageField(
                        help_text="Optional background photo", null=True, blank=True
                    ),
                ),
                (
                    "race_type",
                    models.IntegerField(
                        default=1, choices=[(1, "Run"), (2, "Bike"), (3, "Swim")]
                    ),
                ),
                ...
                (
                    "distance",
                    models.CharField(
                        help_text="eg 26.2", max_length=100, null=True, blank=True
                    ),
                ),
                (
                    "unit",
                ...
                (
                    "course_map",
                    models.URLField(
                        help_text="Link to course map if avail.", null=True, blank=True
                    ),
                ),
                (
                    "cut_off",
                    models.CharField(
                        help_text="eg: 13 hours", max_length=75, null=True, blank=True
                    ),
                ),
                (
                    "reg_url",
                ...
                (
                    "entry_form",
                    models.FileField(
                        null=True, upload_to="races/entry_forms", blank=True
                    ),
                ),
                (
                    "discounts",
                ...
                (
                    "lodging",
                    models.URLField(
                        help_text="Link to lodging information", null=True, blank=True
                    ),
                ),
                ...
                (
                    "facebook_url",
                    models.URLField(
                        help_text="Link to Facebook page", null=True, blank=True
                    ),
                ),
                (
                    "facebook_event_url",
                    models.URLField(
                        help_text="Link to Facebook Event page", null=True, blank=True
                    ),
                ),
                (
                    "location",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dns",
                    models.BooleanField(default=False, verbose_name="Did not Start"),
                ),
                (
                    "dnf",
